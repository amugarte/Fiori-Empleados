		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Empleados",
									"targetURL": "#gonacproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gonacproject1-display": {
								"semanticObject": "gonacproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gonac.project1",
									"url": sap.ui.require.toUrl("gonac/project1")
								}
							}
						}
					}
